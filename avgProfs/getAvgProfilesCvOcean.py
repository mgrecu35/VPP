...
plt.suptitle("Convective Ocean")
plt.subplot(121)
for i in range(0,20):
    plt.scatter(zmL1[i,:],range(0,88))
...
plt.subplot(122)
for i in range(0,20):
    plt.scatter(zmL1[i,:]/zmL1[i,68+i],-(68+i)+np.arange(0,88))
...
plt.xlabel('')
plt.tight_layout()
plt.savefig("avg_cv_Profiles_Ocean.png")

import pickle
pickle.dump(zmL1,open("zmL1_Ocean_cv.pklz","wb"))
stop
#plt.figure()
