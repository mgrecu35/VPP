...
for i in range(136,175):
    a=np.nonzero(bzdLs==i)
    b=np.nonzero(bcfLs[a]>164)
    zmL1.append(10*np.log10((10**(0.1*zmLs[a][b])).mean(axis=0)))
    cL1.append(len(b[0]))
    b=np.nonzero(bcfLs[a]<=164)
    zmL2.append(10*np.log10((10**(0.1*zmLs[a][b])).mean(axis=0)))
    cL2.append(len(b[0]))
...
plt.subplot(311)
f=plt.pcolormesh(range(136,175),range(40,176),\
               zmL1.T,cmap='jet',vmin=10,vmax=50)
...
plt.colorbar()
plt.subplot(312)
plt.pcolormesh(range(136,175),range(40,176),\
               zmL2.T,cmap='jet',vmin=10,vmax=50)
plt.ylim(176,100)
plt.ylabel('Range')
...
axes1.plot(range(136,175),cL1)
axes1.plot(range(136,175),cL2)
plt.xlim(136,175)
plt.ylabel('Counts')
plt.xlabel('FL bin')

plt.savefig('zMap_Land.png')

plt.figure()
plt.subplot(121)
for i in range(20,30):
    plt.plot(zmL1[i,:],range(40,176))
plt.ylim(168,100)
plt.xlim(0,40)
...
#plt.ylabel('Relative range bin')
plt.xlabel('dBZ')
plt.title('166<=FL bin<174')
plt.tight_layout()
plt.savefig('avegZ_land.png')

plt.figure()
plt.subplot(121)
for i in range(20,35):
    plt.plot(zmL1[i,:],-(136+i)+np.arange(40,176))
plt.ylim(10,-60)
plt.xlim(0,40)
plt.ylabel('Relative range bin')
plt.xlabel('dBZ')
plt.title('156<=FL bin<171')

plt.subplot(122)
for i in range(30,38):
    plt.plot(zmL1[i,:],-(i+136)+np.arange(40,176))
plt.ylim(15,-60)
plt.xlim(0,40)
plt.title('166=FL bin<174')
#plt.ylabel('Relative range bin')
plt.xlabel('dBZ')
plt.tight_layout()
plt.savefig('avegZ_rel_to_FL_land.png')
